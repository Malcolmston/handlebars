...
import { HANDLEBARS } from '../data';

// Scoped to this repository only: the live release history is read straight from
// the GitHub Releases API for malcolmston/handlebars.
const RELEASE_LIBS: RelLib[] = [
  { name: HANDLEBARS.name, icon: HANDLEBARS.icon, accent: HANDLEBARS.accent, repo: ghrepo(HANDLEBARS), url: HANDLEBARS.repo },
];
